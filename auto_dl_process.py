...
linePDF.rect(25, 77, 0.25, 104,'F')
linePDF.set_fill_color(0,0,0)
linePDF.rect(68, 77, 0.25, 104,'F')
linePDF.set_fill_color(0,0,0)
linePDF.rect(84, 77, 0.25, 104,'F')
linePDF.set_fill_color(0,0,0)
linePDF.rect(111.5, 77, 0.25, 90,'F')
linePDF.set_fill_color(0,0,0)
linePDF.rect(126, 77, 0.25, 90,'F')

linePDF.set_fill_color(0,0,0)
linePDF.rect(25, 174, 59, 0.25,'F')
linePDF.set_fill_color(0,0,0)
linePDF.rect(25, 181, 59, 0.25,'F')
