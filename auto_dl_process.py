...
linePDF.rect(29, 106, 0.25, 75,'F')
linePDF.set_fill_color(0,0,0)
linePDF.rect(61, 106, 0.25, 75,'F')
linePDF.set_fill_color(0,0,0)
linePDF.rect(73, 106, 0.25, 75,'F')
linePDF.set_fill_color(0,0,0)
linePDF.rect(93, 106, 0.25, 65,'F')
linePDF.set_fill_color(0,0,0)
linePDF.rect(104, 106, 0.25, 65,'F')

linePDF.set_fill_color(0,0,0)
linePDF.rect(29, 175, 44, 0.25,'F')
linePDF.set_fill_color(0,0,0)
linePDF.rect(29, 181, 44, 0.25,'F')
