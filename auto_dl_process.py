...
linePDF.rect(30, 115, 0.25, 88,'F')
linePDF.set_fill_color(0,0,0)
linePDF.rect(64, 115, 0.25, 88,'F')
linePDF.set_fill_color(0,0,0)
linePDF.rect(76, 115, 0.25, 88,'F')
linePDF.set_fill_color(0,0,0)
linePDF.rect(98, 115, 0.25, 76,'F')
linePDF.set_fill_color(0,0,0)
linePDF.rect(110, 115, 0.25, 76,'F')

linePDF.set_fill_color(0,0,0)
linePDF.rect(30, 192, 51.5, 0.25,'F')
linePDF.set_fill_color(0,0,0)
linePDF.rect(30, 198, 51.5, 0.25,'F')
