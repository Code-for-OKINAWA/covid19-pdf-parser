...
linePDF.rect(36, 107, 0.25, 72,'F')
linePDF.set_fill_color(0,0,0)
linePDF.rect(65, 107, 0.25, 72,'F')
linePDF.set_fill_color(0,0,0)
linePDF.rect(76, 107, 0.25, 72,'F')
linePDF.set_fill_color(0,0,0)
linePDF.rect(93.5, 107, 0.25, 62,'F')
linePDF.set_fill_color(0,0,0)
linePDF.rect(104.5, 107, 0.25, 62,'F')

linePDF.set_fill_color(0,0,0)
linePDF.rect(36, 173, 40, 0.25,'F')
linePDF.set_fill_color(0,0,0)
linePDF.rect(36, 179, 40, 0.25,'F')
