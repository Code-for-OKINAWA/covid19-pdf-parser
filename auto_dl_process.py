...
linePDF.rect(30, 115, 0.25, 83,'F')
linePDF.set_fill_color(0,0,0)
linePDF.rect(64, 115, 0.25, 83,'F')
linePDF.set_fill_color(0,0,0)
linePDF.rect(76, 115, 0.25, 83,'F')
linePDF.set_fill_color(0,0,0)
linePDF.rect(98, 115, 0.25, 72,'F')
linePDF.set_fill_color(0,0,0)
linePDF.rect(110, 115, 0.25, 72,'F')

linePDF.set_fill_color(0,0,0)
linePDF.rect(30, 192, 46, 0.25,'F')
linePDF.set_fill_color(0,0,0)
linePDF.rect(30, 198, 46, 0.25,'F')
