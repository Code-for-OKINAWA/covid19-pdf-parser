...
linePDF.rect(35.5, 102.5, 0.25, 68,'F')
linePDF.set_fill_color(0,0,0)
linePDF.rect(65, 102.5, 0.25, 68,'F')
linePDF.set_fill_color(0,0,0)
linePDF.rect(76, 102.5, 0.25, 68,'F')
linePDF.set_fill_color(0,0,0)
linePDF.rect(96, 102.5, 0.25, 60,'F')
linePDF.set_fill_color(0,0,0)
linePDF.rect(106, 102.5, 0.25, 60,'F')

linePDF.set_fill_color(0,0,0)
linePDF.rect(35.5, 167, 40.5, 0.25,'F')
linePDF.set_fill_color(0,0,0)
linePDF.rect(35.5, 170.5, 40.5, 0.25,'F')
